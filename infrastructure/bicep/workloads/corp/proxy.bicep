...
resource cloudSubnet 'Microsoft.Network/virtualNetworks/subnets@2023-11-01' existing = {
  parent: vnet
...
module vmProxy '../../modules/virtualMachineProxy.bicep' = {
  ...
  params: {
    ...
    frontSubnetId: cloudSubnet.id
    backSubnetId: corpSubnet.id
    frontPrivateIPAddress: network.subnets.corp.proxy.frontPrivateIPAddress
    backPrivateIPAddress: network.subnets.corp.proxy.backPrivateIPAddress
